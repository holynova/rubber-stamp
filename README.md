...
<p align="center">
  <img src="assets/readme/hero.svg" width="100%" alt="橡胶戳艺术印记 · 世界城市 / 名胜风景 / 古诗名句 / 十二生肖 / 二十四节气 / 山海神异: 复古手工多色橡胶戳印艺术画廊，收录 176 枚纯印章艺术作品（世界城市 30 枚、名胜风景 50 枚、古诗名句 50 枚、十二生肖 12 枚、二十四节气 24 枚、山海神异 10 枚）。画面剥离文字与排版干扰，保留纯粹版画雕刻图章主体与米白纤维纸张质感。">
</p>
...
仓库为静态 HTML / JavaScript 画廊。安装 Python 3 后，在仓库根目录运行：

```bash
python3 -m http.server 8080
```

打开 [localhost:8080](http://localhost:8080)。也可通过 `npm run dev` 启动同一服务器；浏览已有画廊无需运行生成图片的 Python 脚本。
